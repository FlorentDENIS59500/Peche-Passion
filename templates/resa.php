...
<main>
    ...
    <div class="container_resa">
        <div class="reservation">
            <h4>Réservation</h4>
            <form class="form-resa" method="post" action="resa2.php">
                <div class="cont1 resa">
                    ...
                    <br>
                    <input type="tel" name="Telephone" pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" id="Telephone" placeholder="N° Téléphone" size="10" required />
                    <br>
